...
void test_block(void) {
  ...
  void __attribute__((__format__(__printf__, 2, 3))) (^printf_arg2)( // #printf_arg2
    ...
    va_start(ap, fmt);
    vprintf(fmt, ap);
    vprintf(not_fmt, ap); // expected-warning{{diagnostic behavior may be improved by adding the 'format(printf, 1, 0)' attribute to the declaration of 'printf_arg2'}}
    // expected-note@#printf_arg2 {{'printf_arg2' declared here}}
    va_end(ap);
  };
